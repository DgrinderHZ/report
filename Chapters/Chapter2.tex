...
Les études que nous allons réalisés portent principalement sur des descripteurs bas-niveau, par la mise en place des descripteurs couleur, texture et forme.\\  
...
Où $p_{ij}$ représente la position du pixel, $N$ représente le nombre total des pixels dans cette image.\\
...
\begin{figure}[H]
	\label{fig:forme}
	\centering
	\includegraphics[width=0.85\textwidth]{Figures/forme} % Include the image .png
