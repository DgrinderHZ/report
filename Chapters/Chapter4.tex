...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{curet} 
...
\begin{figure}[H]
	\includegraphics[width=0.5\textwidth]{baseC} \space
	\includegraphics[width=0.5\textwidth]{baseT} 
	\caption{L'interface d’utilisateur, section requête: \\
	Gauche: basé couler, Droite: Basé texture.}
\end{figure}
\begin{figure}[H]
	\includegraphics[width=0.5\textwidth]{baseF} \space
	\includegraphics[width=0.5\textwidth]{baseCTS} 
	\caption{L'interface d’utilisateur, section requête: \\
