...
\begin{figure}[H]
	\centering
	\includegraphics[width=.7\textwidth]{Haralick options} 
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.7\textwidth]{GaborOptions} 
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.7\textwidth]{HuOptions} 
...
\begin{figure}[H]
	\centering
	\includegraphics[width=.7\textwidth]{ZernikeOptions} 
