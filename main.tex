...
\begin{Large}
	...
	\dedicatory{
		...
		Je remercie vivement -----    d'avoir accepté de juger notre travail.\\
		...
		Enfin, je remercie s toutes ma familles et mes
		amis.
...
\begin{thebibliography}{widest entry}
	...
	\bibitem[Fauqueurs03 ]{ Fauqueurs03}  Julien Fauqueur. "Contributions pour la Recherche d’Images par Composantes Visuelles. Interface homme-machine [cs.HC]". Université de Versailles-Saint Quentin en Yvelines, 2003. Français. ﬀtel-00007090ﬀ.
